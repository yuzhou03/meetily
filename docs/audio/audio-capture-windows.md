...
- [1. Overview](#1-overview)
  - [1.1 What is different on Windows?](#11-what-is-different-on-windows)
  - [1.2 High-level architecture](#12-high-level-architecture)
- [2. Module Layout](#2-module-layout)
- [3. Recording Lifecycle](#3-recording-lifecycle)
- [4. Device Discovery and Configuration](#4-device-discovery-and-configuration)
  - [4.1 Why WASAPI](#41-why-wasapi)
  - [4.2 WASAPI enumeration](#42-wasapi-enumeration)
  - [4.3 Resolving a device to a `cpal::Device`](#43-resolving-a-device-to-a-cpaldevice)
  - [4.4 Permission probing](#44-permission-probing)
- [5. Capture Backends on Windows](#5-capture-backends-on-windows)
- [6. Stream Construction](#6-stream-construction)
  - [6.1 `AudioStream` and `AudioStreamManager`](#61-audiostream-and-audiostreammanager)
  - [6.2 `create_cpal_stream`](#62-create_cpal_stream)
  - [6.3 Stopping a stream](#63-stopping-a-stream)
- [7. Per-Stream Processing: `AudioCapture`](#7-per-stream-processing-audiocapture)
  - [7.1 `process_audio_data(data: &[f32])` flow](#71-process_audio_datadata-f32-flow)
  - [7.2 Resampling](#72-resampling)
  - [7.3 Error handling](#73-error-handling)
- [8. Pipeline, Mixer, and VAD](#8-pipeline-mixer-and-vad)
  - [8.1 `AudioMixerRingBuffer`](#81-audiomixerringbuffer)
  - [8.2 `ProfessionalAudioMixer`](#82-professionalaudiomixer)
  - [8.3 VAD](#83-vad)
  - [8.4 FFmpeg-style adaptive mixer (reference / future)](#84-ffmpeg-style-adaptive-mixer-reference--future)
- [9. Device Classification and Adaptive Behavior](#9-device-classification-and-adaptive-behavior)
  - [9.1 Windows-specific detection patterns](#91-windows-specific-detection-patterns)
  - [9.2 Adaptive buffer timeouts](#92-adaptive-buffer-timeouts)
- [10. Persistence and Recovery](#10-persistence-and-recovery)
  - [10.1 Folder structure](#101-folder-structure)
  - [10.2 Incremental saver](#102-incremental-saver)
  - [10.3 Crash recovery](#103-crash-recovery)
  - [10.4 Transcript persistence](#104-transcript-persistence)
- [11. Device Hot-Plug Monitoring](#11-device-hot-plug-monitoring)
- [12. Level Monitoring](#12-level-monitoring)
- [13. Transcription Engine Integration](#13-transcription-engine-integration)
- [14. Error Handling](#14-error-handling)
  - [14.1 Error → action map](#141-error--action-map)
- [15. Performance Optimizations](#15-performance-optimizations)
- [16. Compatibility Matrix (Windows)](#16-compatibility-matrix-windows)
- [17. Extending the Windows Path](#17-extending-the-windows-path)
  - [17.1 Adding a new virtual audio device (e.g. a custom loopback cable)](#171-adding-a-new-virtual-audio-device-eg-a-custom-loopback-cable)
  - [17.2 Replacing the VAD](#172-replacing-the-vad)
  - [17.3 Enabling noise suppression](#173-enabling-noise-suppression)
  - [17.4 Migrating to `audio_v2`](#174-migrating-to-audio_v2)
- [18. Key Code References](#18-key-code-references)
